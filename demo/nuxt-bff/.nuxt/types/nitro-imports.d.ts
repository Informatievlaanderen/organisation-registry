declare global {
  ...
  const clearSession: typeof import('../../server/utils/session').clearSession
  ...
  const saveSession: typeof import('../../server/utils/session').saveSession
...
declare global {
  ...
  // @ts-ignore
  export type { Session } from '../../server/utils/session'
...
export { buildAssetsURL as __buildAssetsURL, publicAssetsURL as __publicAssetsURL } from '/code/aiv/organisation-registry/demo/nuxt-bff/node_modules/@nuxt/nitro-server/dist/runtime/utils/paths';
export { defineAppConfig } from '/code/aiv/organisation-registry/demo/nuxt-bff/node_modules/@nuxt/nitro-server/dist/runtime/utils/config';
export { getSession, saveSession, clearSession } from '/code/aiv/organisation-registry/demo/nuxt-bff/server/utils/session';