...
namespace OrganisationRegistry.Import.Piavo.Models
{
    ...
    public partial class ClassificationOrganisationParticipation
    {
        /// <summary>
        /// Initializes a new instance of the
        /// ClassificationOrganisationParticipation class.
        /// </summary>
        public ClassificationOrganisationParticipation() { }

        /// <summary>
        /// Initializes a new instance of the
        /// ClassificationOrganisationParticipation class.
        /// </summary>
        public ClassificationOrganisationParticipation(System.Guid? organisationId = default(System.Guid?), string organisationName = default(string), System.Guid? bodyId = default(System.Guid?), string bodyName = default(string), double? malePercentage = default(double?), double? femalePercentage = default(double?), double? unknownPercentage = default(double?), int? maleCount = default(int?), int? femaleCount = default(int?), int? unknownCount = default(int?), int? totalCount = default(int?), int? assignedCount = default(int?), int? unassignedCount = default(int?))
        {
