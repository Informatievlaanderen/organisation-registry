namespace OrganisationRegistry.UnitTests.Organisation.Kbo
{
    ...
    public class CoupleWithAlreadyUsedKboNumberTests: ExceptionSpecification<Organisation, KboOrganisationCommandHandlers, CoupleOrganisationToKbo>
    {
        ...
        private OrganisationId _anotherOrganisationId;
        ...
        protected override IEnumerable<IEvent> Given()
        {
            ...
            _anotherOrganisationId = new OrganisationId(Guid.NewGuid());
            ...
            return new List<IEvent>
            {
                ...
                new OrganisationCreated(
                    ...
                    "organisation Y",
                    "OVO001235",
                    "org y", Article.None, "", new List<Purpose>(), false, new ValidFrom(), new ValidTo(),
                    new ValidFrom(),
                    new ValidTo()),
        ...
        {
            Exception.Should().BeOfType<KboNumberNotUniqueException>();
        }
