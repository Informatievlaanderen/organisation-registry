namespace OrganisationRegistry.UnitTests.Organisation.AddOrganisationParent
{
    ...
    public class WhenAddingAVlimpersOrganisationAsParentForANonVlimpersOrganisation : OldExceptionSpecification<Organisation, OrganisationCommandHandlers, AddOrganisationParent>
    {
        ...
        public WhenAddingAVlimpersOrganisationAsParentForANonVlimpersOrganisation(ITestOutputHelper helper) : base(helper) { }
    }
}
