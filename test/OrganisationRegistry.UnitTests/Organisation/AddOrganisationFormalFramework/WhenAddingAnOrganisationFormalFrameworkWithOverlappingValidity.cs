namespace OrganisationRegistry.UnitTests.Organisation.AddOrganisationFormalFramework
{
    ...
    public class WhenAddingAnOrganisationFormalFrameworkWithOverlappingValidity : ExceptionSpecification<Organisation, OrganisationCommandHandlers, AddOrganisationFormalFramework>
    {
        ...
        protected override IEnumerable<IEvent> Given()
        {
            ...
            _childBecameDaughterOfParent = new OrganisationFormalFrameworkAddedTestDataBuilder(_childOrganisationCreated.Id, _formalFrameworkCreated.Id, _parentOrganisationCreated.Id)
