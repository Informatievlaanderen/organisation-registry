namespace OrganisationRegistry.UnitTests.Organisation.UpdateOrganisationLocation
{
    ...
    public class WhenUpdatingAnOrganisationLocationToMainLocation : Specification<Organisation, OrganisationCommandHandlers, UpdateOrganisationLocation>
    {
        ...
        protected override IEnumerable<IEvent> Given()
        {
            ...
            return new List<IEvent>
            {
                ...
                new OrganisationLocationAdded(_organisationId, _organisationLocationId, _locationId, "Gebouw A", false, null, null, _validFrom, _validTo)
            };
        }
