...
public class WhenAddingAnOrganisationCapacityInTheFuture
    : Specification<AddOrganisationCapacityCommandHandler, AddOrganisationCapacity>
{
    ...
    public WhenAddingAnOrganisationCapacityInTheFuture(ITestOutputHelper helper) : base(helper)
    {
    ...
    public async Task PublishesOneEvent()
    {
        ...
        organisationCapacityAdded.ValidFrom.Should().Be(_dateTimeProviderStub.Today.AddDays(value: 1));
        organisationCapacityAdded.ValidTo.Should().Be(_dateTimeProviderStub.Today.AddDays(value: 2));
    }
