...
public class FunctionPolicyTests
{
    private readonly Fixture _fixture;
    private readonly IOrganisationRegistryConfiguration _configuration;

    public FunctionPolicyTests()
    {
    ...
    private static FunctionPolicy CreatePolicy(string ovoNumber)
        => new(ovoNumber);
    ...
    public void DecentraalBeheerderIsNotAuthorizedForOtherOrganisations()
    {
        ...
        CreatePolicy(_fixture.Create<string>())
            .Check(user)
            .ShouldFailWith<InsufficientRights<FunctionPolicy>>();
    }
