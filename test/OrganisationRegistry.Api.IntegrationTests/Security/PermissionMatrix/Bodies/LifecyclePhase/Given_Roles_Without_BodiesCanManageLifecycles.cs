...
public class Given_Roles_Without_BodiesCanManageLifecycles
{
    private readonly ApiFixture _apiFixture;

    public Given_Roles_Without_BodiesCanManageLifecycles(ApiFixture apiFixture)
    {
    ...
    public async Task Then_Returns_Forbidden(string role)
    {
        ...
        var response = await ApiFixture.Post(
            ...
            new AddBodyLifecyclePhaseRequest
            {
                ...
                LifecyclePhaseTypeId = _apiFixture.Fixture.Create<Guid>(),
                ValidFrom = null,
                ValidTo = null,
            });
