namespace OrganisationRegistry.Api.IntegrationTests.Security.PermissionMatrix.Organisation.BankAccounts.When_Adding_BankAccounts;
...
/// Bankrekeningen worden in de toekomst verwijderd uit het register; de permissie bestaat
...
/// en Developer — krijgt dus 403 bij het toevoegen van een bankrekeningnummer.
/// </summary>
...
public class Given_No_Role_Has_CanManageBankAccounts
{
    ...
    public async Task Then_Returns_Forbidden(string role)
    {
        ...
        var response = await ApiFixture.Post(
            client,
            $"/v1/organisations/{organisationId}/bankAccounts",
            new
            {
