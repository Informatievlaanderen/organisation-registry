namespace OrganisationRegistry.SqlServer.IntegrationTests.OnProjections.Body.WhenScheduledCommandsAreRun
{
    ...
    public class Given_some_activeBodyOrganisation
    {
        [Fact]
        public async Task Then_The_Correct_UpdateCurrentOrganisationParent_Commands_Are_Generated()
        {
            ...
            var expectedCommands = new List<ICommand>
            {
                new UpdateCurrentBodyOrganisation(
                    new BodyId(activeBodyOrganisation1.BodyId)),
                new UpdateCurrentBodyOrganisation(
                    new BodyId(activeBodyOrganisation3.BodyId)),
                new UpdateCurrentBodyOrganisation(
                    new BodyId(activeBodyOrganisation4.BodyId)),
            };
