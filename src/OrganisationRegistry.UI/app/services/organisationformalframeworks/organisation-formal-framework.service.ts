...
export class OrganisationFormalFrameworkService {
  ...
  public getOrganisationFormalFrameworks(
  ...
  ): Observable<PagedResult<OrganisationFormalFrameworkListItem>> {
    ...
    return this.http
      .get(this.getOrganisationFormalFrameworksUrl(organisationId), {
        headers: headers,
      })
  ...
  public get(
    organisationId: string,
    organisationFormalFrameworkId: string
  ): Observable<OrganisationFormalFramework> {
    const url = `${this.getOrganisationFormalFrameworksUrl(
      organisationId
  ...
  public create(
    organisationId,
    organisationFormalFramework: CreateOrganisationFormalFrameworkRequest
  ): Observable<string> {
    let headers = new HeadersBuilder().json().build();

    return this.http
      .post(
        this.getOrganisationFormalFrameworksUrl(organisationId),
        JSON.stringify(organisationFormalFramework),
        { headers: headers }
      )
  ...
  public update(
    organisationId,
    organisationFormalFramework: UpdateOrganisationFormalFrameworkRequest
  ): Observable<boolean> {
    const url = `${this.getOrganisationFormalFrameworksUrl(organisationId)}/${
    ...
    return this.http
      .put(url, JSON.stringify(organisationFormalFramework), {
        headers: headers,
      })
  ...
  private toOrganisationFormalFramework(
    res: Response
  ...
  private toOrganisationFormalFrameworks(
    res: Response
  ): PagedResult<OrganisationFormalFrameworkListItem> {
    return new PagedResultFactory<OrganisationFormalFrameworkListItem>().create(
      res.headers,
      res.json()
    );
  }

  delete(organisationId: string, organisationFormalFrameworkId: string) {
    const url = `${this.getOrganisationFormalFrameworksUrl(
      organisationId
    )}/${organisationFormalFrameworkId}`;
    let headers = new HeadersBuilder().json().build();
