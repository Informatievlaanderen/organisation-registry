...
@Component({
  templateUrl: 'updateorganisation.template.html',
  styleUrls: ['updateorganisation.style.css']
})
export class BodyMandatesUpdateOrganisationComponent implements OnInit, OnDestroy {
