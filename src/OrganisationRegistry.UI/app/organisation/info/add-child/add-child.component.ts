...
export class OrganisationInfoAddChildOrganisationComponent
        ...
        .subscribe(
          (allPurposes) => {
            ...
            this.route.parent.parent.params.forEach((params: Params) => {
              ...
              this.organisation = new CreateOrganisationFormValues();
              this.organisation.parentOrganisationId =
  ...
  private onCreateSuccess(result, organisation) {
    if (result) {
      ...
      let organisationUrl = this.router.serializeUrl(
        this.router.createUrlTree(["./../../../", organisation.id], {
          relativeTo: this.route,
        })
      );

      this.alertService.setAlert(
        this.createAlerts.saveSuccess(organisation, organisationUrl)
      );
    }
  }
}
