...
export class OrganisationBankAccountsListComponent extends BaseListComponent<OrganisationBankAccountListItem> {
  ...
  @Output()
  removeBankAccountClicked: EventEmitter<OrganisationBankAccountListItem> = new EventEmitter<OrganisationBankAccountListItem>();

  remove(bankAccount: OrganisationBankAccountListItem) {
    this.removeBankAccountClicked.emit(bankAccount);
  }
}
