  ...
  implements OnInit, OnDestroy
{
  ...
  constructor(
    ...
    this.organisationRegulations =
      new PagedResult<OrganisationRegulationListItem>();
  }
  ...
  private loadRegulations(event?: PagedEvent) {
    ...
    let regulations =
      event === undefined
        ? this.organisationRegulationService.getOrganisationRegulations(
            this.organisationId,
            this.filter,
            this.currentSortBy,
    ...
    this.subscriptions.push(
      regulations
        ...
        .subscribe(
          (items) => {
            if (items) this.organisationRegulations = items;
          },
          (error) =>
