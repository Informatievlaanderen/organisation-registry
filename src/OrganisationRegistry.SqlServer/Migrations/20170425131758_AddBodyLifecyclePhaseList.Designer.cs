...
namespace OrganisationRegistry.SqlServer.Migrations
{
    ...
    [Migration("20170425131758_AddBodyLifecyclePhaseList")]
    partial class AddBodyLifecyclePhaseList
    {
        protected override void BuildTargetModel(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity("OrganisationRegistry.SqlServer.Body.BodyLifecyclePhaseListItem", b =>
                {
                    ...
                    b.Property<string>("LifecyclePhaseName")
                        .IsRequired()
                        .HasMaxLength(500);
            ...
            modelBuilder.Entity("OrganisationRegistry.SqlServer.LifecyclePhase.LifecyclePhaseListItem", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd();
                    ...
                    b.ToTable("LifecyclePhaseList","OrganisationRegistry");
                });
