...
namespace OrganisationRegistry.Import.Piavo.Models
{
    ...
    {
        /// <summary>
        /// Initializes a new instance of the UpdatePersonRequest class.
        /// </summary>
        ...
        public UpdatePersonRequest(string firstName = default(string), string name = default(string), string sex = default(string), System.DateTime? dateOfBirth = default(System.DateTime?))
        {
            FirstName = firstName;
            Name = name;
            Sex = sex;
