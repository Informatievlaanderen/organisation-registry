namespace OrganisationRegistry.Api.DelegationAssignments.Requests
{
    using System;
    ...
    {
        public static UpdateDelegationAssignment Map(UpdateDelegationAssignmentInternalRequest message)
        {
            return new UpdateDelegationAssignment(
