namespace OrganisationRegistry.Api.Body
{
    ...
    public class BodySeatController : OrganisationRegistryController
    {
        ...
        public IActionResult Post([FromServices] ISecurityService securityService, [FromRoute] Guid bodyId, [FromBody] AddBodySeatRequest message)
        {
            ...
            CommandSender.Send(AddBodySeatRequestMapping.Map(internalMessage));
        ...
        [ProducesResponseType(typeof(BadRequestResult), (int)HttpStatusCode.BadRequest)]
        public IActionResult Put([FromServices] ISecurityService securityService, [FromRoute] Guid bodyId, [FromBody] UpdateBodySeatRequest message)
        {
            ...
            CommandSender.Send(UpdateBodySeatRequestMapping.Map(internalMessage));
