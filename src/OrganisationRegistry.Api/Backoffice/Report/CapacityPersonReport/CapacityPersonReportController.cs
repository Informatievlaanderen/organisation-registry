...
public class CapacityPersonReportController: OrganisationRegistryController
{
    ...
    [ProducesResponseType(typeof(List<CapacityPerson>), StatusCodes.Status200OK)]
    [SwaggerResponseExample(StatusCodes.Status200OK, typeof(CapacityPersonListExamples))]
