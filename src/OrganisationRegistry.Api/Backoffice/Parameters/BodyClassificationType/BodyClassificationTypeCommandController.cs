...
[OrganisationRegistryAuthorize(RequiredPermissions = [Permission.ParametersBodyClassificationTypesWrite])]
...
public class BodyClassificationTypeCommandController : OrganisationRegistryCommandController
{
    ...
    public async Task<IActionResult> Post([FromBody] CreateBodyClassificationTypeRequest message)
    {
        ...
        return CreatedWithLocation(nameof(BodyClassificationTypeController), "Get", new { id = message.Id });
    }
    ...
    public async Task<IActionResult> Put([FromRoute] Guid id, [FromBody] UpdateBodyClassificationTypeRequest message)
    {
        ...
        return OkWithLocationHeader(nameof(BodyClassificationTypeController), "Get", new { id = internalMessage.BodyClassificationTypeId });
    }
}
