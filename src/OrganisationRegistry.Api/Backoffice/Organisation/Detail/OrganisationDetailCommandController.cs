...
public class OrganisationDetailCommandController : OrganisationRegistryCommandController
{
        ...
        [FromBody] CreateOrganisationRequest message)
    {
        ...
        return CreatedWithLocation(nameof(OrganisationDetailController), "Get", new { id = message.Id });
    }
        ...
        [FromBody] UpdateOrganisationInfoRequest message)
    {
        ...
        return OkWithLocationHeader(nameof(OrganisationDetailController), "Get", new { id = internalMessage.OrganisationId });
    }
