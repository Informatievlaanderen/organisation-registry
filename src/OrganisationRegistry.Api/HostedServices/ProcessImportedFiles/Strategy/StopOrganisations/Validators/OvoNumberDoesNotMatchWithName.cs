namespace OrganisationRegistry.Api.HostedServices.ProcessImportedFiles.Strategy.StopOrganisations.Validators;
...
public static class OvoNumberDoesNotMatchWithName
{
    ...
    public static string FormatMessage(string ovoNumber, string? name)
        => $"Ovo nummer {ovoNumber} komt niet overeen met organisatie {name}.";
}
