...
public record DeserializedRecord
{
    ...
    public CreateOrganisationsFromImportCommandItem ToOutputRecord(Dictionary<string, (Guid id, string name)> labelTypes, OrganisationParentIdentifier parentidentifier, int sortOrder)
