namespace OrganisationRegistry.Api.Organisation
{
    ...
    public class OrganisationParentController : OrganisationRegistryController
    {
        ...
        public IActionResult Post([FromServices] ISecurityService securityService, [FromRoute] Guid organisationId, [FromBody] AddOrganisationParentRequest message)
        {
            ...
            CommandSender.Send(AddOrganisationParentRequestMapping.Map(internalMessage));
        ...
        [ProducesResponseType(typeof(BadRequestResult), (int)HttpStatusCode.BadRequest)]
        public IActionResult Put([FromServices] ISecurityService securityService, [FromRoute] Guid organisationId, [FromBody] UpdateOrganisationParentRequest message)
        {
            ...
            CommandSender.Send(UpdateOrganisationParentRequestMapping.Map(internalMessage));
