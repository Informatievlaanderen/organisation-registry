...
public class UpdateOrganisationContactInternalRequestValidator : AbstractValidator<UpdateOrganisationContactRequest>
{
...
{
    public static UpdateOrganisationContact Map(Guid organisationId, Guid organisationContactId, UpdateOrganisationContactRequest message)
        => new(
