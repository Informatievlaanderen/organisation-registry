...
/// <summary>
/// Role-independent authorization for managing organisation buildings. Access is
/// driven entirely by the <see cref="Permission.CanManageBuildings"/> permission
/// and its (optional) restrictions, evaluated against a
/// <see cref="OrganisationContext"/>.
///
/// A holder of an unrestricted <c>CanManageBuildings</c> grant (e.g.
...
/// </summary>
public class BuildingPolicy : ISecurityPolicy
{
    private readonly string _ovoNumber;

    public BuildingPolicy(string ovoNumber)
    {
