...
/// <summary>
/// Role-independent authorization for managing organisation relations. Access is
/// driven entirely by the <see cref="Permission.CanManageRelations"/> permission
/// and its (optional) restrictions, evaluated against a
/// <see cref="OrganisationContext"/>.
///
/// A holder of an unrestricted <c>CanManageRelations</c> grant (e.g.
...
/// </summary>
public class RelationPolicy : ISecurityPolicy
{
    private readonly string _ovoNumber;

    public RelationPolicy(string ovoNumber)
    {
